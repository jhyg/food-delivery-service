<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <String label="메뉴" v-model="value.menu" :editMode="editMode" :inputUI="''"/>
            <Number label="수량" v-model="value.quantity" :editMode="editMode" :inputUI="''"/>
            <Money offline label="결제" v-model="value.payment" :editMode="editMode" @change="change"/>
...
<script>
    ...
    export default {
        name: 'CustomerOrderManagementOrder',
        components:{
            Money,
        },
        props: {
