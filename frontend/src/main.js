...
pluralCaseList.push( {plural: "customerOrderManagements/orders", pascal: "CustomerOrderManagementOrder"} )

pluralCaseList.push( {plural: "menuManagements/menus", pascal: "MenuManagementMenu"} )
