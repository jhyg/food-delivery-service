            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="orders"
                        to="/customerOrderManagements/orders"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '주문', 
                description: '주문을 나타내는 집합', 
                key: 'orders', 
                route: '/customerOrderManagements/orders',
                ImageUrl: '',
            },
            { 
                title: '메뉴', 
                description: '메뉴를 나타내는 집합', 
                key: 'menus', 
                route: '/menuManagements/menus',
                ImageUrl: '',
            },
            { 
                title: '배달', 
                description: '배달을 나타내는 집합', 
                key: 'deliveries', 
